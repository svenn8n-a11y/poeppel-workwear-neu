...
### 29.01.2026 - Sektion 4: Optimierte Bilder integriert (3 Größen)
- [x] Neue optimierte Bilder in `images/04_potentiale` analysiert
- [x] Ordnerstruktur für drei Größen erstellt:
  - `4_Potentiale_Standard/` - Mobile/Standard-Größe
  - `4_Potentiale_420x180/` - Desktop-Größe (1x)
  - `4_Potentiale (840 x 360 px)/` - Retina-Größe (2x)
- [x] Responsive `<picture>`-Elemente mit Media Queries implementiert
- [x] Alle 4 Potentiale-Karten aktualisiert mit 3 Bildgrößen:
  - **Mobile** (< 768px): Standard-Größe (~34-51KB)
  - **Desktop** (≥ 768px, 1x): 420x180px (~15-18KB)
...
### 29.01.2026 - Sektion 12 (Onboarding): Mobile Optimierung (KORRIGIERT)
- [x] **Problem erkannt**: Erster Ansatz zerstörte GSAP-Scroll-Mechanismus
- [x] **Root Cause**: Grid-Layout wurde entfernt, das für diagonale Animation benötigt wird
- [x] **Korrekte Lösung**: Grid-Layout beibehalten, nur Größen anpassen
- [x] **Bildcontainer**: Quadratisch (320x320px) für Mobile
- [x] **Badge-Nummerierung**: Auf Mobile ausgeblendet
- [x] **SVG-Linie**: Separate mobile Version mit korrigierten Koordinaten
  - ViewBox 300x300 (gleich wie Desktop)
  - Pfad: `M 50 70 L 145 70 L 145 170 L 250 170`
  - Läuft zwischen Bildrand und Überschrift
- [x] **JavaScript**: Mobile-Detection für korrekten SVG-Pfad
